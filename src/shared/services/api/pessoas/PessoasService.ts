...
const create = async (dados: Omit<IDetalhePessoa, 'id'>): Promise<number | Error> => {
    try {        
        const { data } = await Api.post<IDetalhePessoa>('/pessoas', dados); // O 1º parâmetro é o URL pra onde vai ser chamado e o 2º é o dado que vai ser enviado para o BackEnd
